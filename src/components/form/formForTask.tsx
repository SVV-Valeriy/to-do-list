...
export const FormForTask: FC<IProps> = ({
    isOpen,
    setOpenModal,
    submit,
    title,
    ...
    const priorityValue = priority ? priority : 3
                ...
                {({ errors, touched, values }) => (
                    <Form>
                        ...
                        <div className={style.form}>
                            ...
                            <AutoValues />
                            <button className={buttonDisabled(values)} type="submit">
                                {buttonName}
                            </button>
                        </div>
                    </Form>
